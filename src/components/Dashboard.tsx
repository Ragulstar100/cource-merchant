        ...
        <Card>
          <BlockStack gap="100">
            <Text variant="headingMd" as="h3">
              Welcome, {merchant.shopOwner || merchant.name || 'Merchant'}!
            </Text>
            <Text variant="bodyMd" as="p" tone="subdued">
              Store Owner: <strong>{merchant.shopOwner || 'Not Specified'}</strong> | Store: <strong>{merchant.name || shop}</strong> ({merchant.email})
            </Text>
          </BlockStack>
        </Card>
      )}
